...
export default {
  ...
  setup() {
    ...
    const entryColumns = tableColumns(locationModel)
    const entryFormFields = locationModel
    ...
    const handleUpdate = async (data) => {
      try {
        await locationService.updateLocation(data.id, data)
