...
export default {
  ...
  setup() {
    ...
    const entryColumns = tableColumns(sellerModel)
    const entryFormFields = sellerModel
    ...
    const handleUpdate = async (data) => {
      try {
        await sellerService.updateSeller(data.id, data)
    ...
    const handleDelete = async (row) => {
      try {
        await sellerService.deleteSeller(row.id)
